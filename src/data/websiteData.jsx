...
export const navLinks = [
    ...
    { label: 'Programmes', icon: null },
    { label: 'Global Partners', icon: null },
    { label: 'Admissions', icon: null },
    { label: 'The INTI Edge', icon: null },
    { label: 'Profile', icon: 'User' }, // User icon for Profile
];
